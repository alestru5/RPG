...
std::list<std::pair<short_characteristic, int>> SetChanges::createChanges(type_artifact T){
    std::list<std::pair<short_characteristic, int>> changes;
        ...
        changes.push_back(std::make_pair(short_characteristic::max_hp, 10));
        changes.push_back(std::make_pair(short_characteristic::cur_hp, 10));
        ...
        changes.push_back(std::make_pair(short_characteristic::max_hp, 20));
        changes.push_back(std::make_pair(short_characteristic::cur_hp, 20));
        ...
        changes.push_back(std::make_pair(short_characteristic::max_hp, 30));
        changes.push_back(std::make_pair(short_characteristic::cur_hp, 30));
        ...
        changes.push_back(std::make_pair(short_characteristic::max_hp, 50));
        changes.push_back(std::make_pair(short_characteristic::cur_hp, 50));
